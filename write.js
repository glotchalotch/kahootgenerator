...
function makePres() {
    for(i = 2; i < questionNum + 1; i++) {
        fs.writeFileSync(`${dirname}/data/kahoot/functions/questions/q${i}pre.mcfunction`, `title @a title "Question ${i}"\ntitle @a subtitle "Begins in 10 seconds"\nschedule function kahoot:questions/q${i} 200`);
    }
}
